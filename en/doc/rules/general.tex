...
\item No function or member function shall have more than \cppid{4} parameters.

\item No function shall have more than \cppid{40} lines when properly formatted.
...
to functions from the standard library (e.g. \cppid{read()} or \cppid{write()}.
